      ...
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(
              60% 120% at 50% -20%, 
              rgba(255, 50, 50, 0.9) 0%,   /* Vermelho Intenso */
              rgba(255, 50, 50, 0.25) 5%,  /* Vermelho Suave */
              rgba(0, 0, 0, 0) 80%
            ) padding-box,
            ...
            radial-gradient(
              ...
              rgba(255, 50, 50, 1) 20%,    /* Vermelho logo a seguir */
        ...
        >
          ...
          <div className="relative z-10 flex h-auto w-full flex-col justify-between gap-5">
            <div className="flex w-full justify-between items-center">
              <Image
                src="/assets/construction/logo.svg"
                alt="Logo"
                width={60}
                height={60}
            ...
            <div className="flex w-[450px] flex-col gap-3 mt-auto mb-6">
              ...
              <p className="text-neutral-200/80 text-2xl leading-relaxed">
                Plataforma de criação de Grids para Design de Sites.
              </p>
            </div>
            ...
            <div className="flex w-full items-center justify-between pt-6">
              <div className="flex w-full items-center justify-between pt-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="switch-2 relative inline-block w-[50px] h-7">
                    <input
                      type="checkbox"
