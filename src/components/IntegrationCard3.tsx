...
const IntegrationCard = ({ className }: { className?: string }) => {
  ...
  return (
    // 2. WRAPPER (Hit Box Invisível com padding extra)
    <div
      ref={wrapperRef}
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            /* CAMADA 1: Spotlight Verde/Mint */
            radial-gradient(
              60% 120% at 50% -20%, 
              rgba(87, 199, 133, 0.9) 0%,   /* Verde Intenso */
              rgba(87, 199, 133, 0.25) 5%,  /* Verde Suave */
              rgba(0, 0, 0, 0) 80%
            ) padding-box,
          ...
          <div className="relative z-10 flex h-auto w-full flex-col justify-between gap-5">
            ...
            <div className="flex w-[500px] flex-col gap-3 mt-auto mb-6">
              ...
              <p className="text-neutral-200/80 text-2xl leading-relaxed">
                Ferramenta que conecta diversos serviços de forma rápida,
            ...
            <div className="flex w-full items-center justify-between pt-6">
              <div className="flex w-full items-center justify-between pt-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label className="switch-3 relative inline-block w-[50px] h-7">
                    <input
                      type="checkbox"
