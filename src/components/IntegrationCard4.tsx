    ...
    <div
      ...
      style={{
        background: `
          ...
          radial-gradient(
            60% 120% at 50% -20%, 
            rgba(237, 221, 83, 0.9) 0%,   /* Vermelho Intenso */
            rgba(237, 221, 83, 0.25) 5%,  /* Vermelho Suave */
            rgba(0, 0, 0, 0) 80%
          ) padding-box,
          ...
          radial-gradient(
            ...
            rgba(237, 221, 83, 0.9) 20%,    /* Vermelho logo a seguir */
      ...
      <div className="relative z-10 flex h-auto w-full flex-col justify-between gap-5">
        <div className="flex w-full justify-between items-center">
          ...
          <div className="flex items-center justify-center text-neutral-200/80 backdrop-blur-2xl gap-2 my-shadow-2 rounded-lg py-2 px-5">
            ...
            <p className="text-[20px] font-montserrat">Para todas as Versões</p>
          </div>
        </div>
        ...
        <div className="flex w-full items-center justify-between pt-6">
          <div className="flex w-full items-center justify-between pt-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <label className="switch-4 relative inline-block w-[50px] h-[28px]">
                <input
                  type="checkbox"
